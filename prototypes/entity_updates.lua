...
local entityData = {
	locomotive = {
		yir_usl = 				{filename = "usl_sheet",		double = true, doublesided = false, size = {2112, 5472}, sizeSh = {3360, 5504}, shift = {0.42,-1.125}},
		...
		yir_ns2200wr = 			{filename = "ns2200wr_sheet",	double = true, doublesided = false, size = {4096, 6912}, sizeSh = {4096, 7488}, shift = {0.42,-1.125}},
		yir_ns2200gg = 			{filename = "ns2200gg_sheet",	double = true, doublesided = false, size = {4096, 6912}, sizeSh = {4096, 7488}, shift = {0.42,-1.125}},
		y_loco_diesel_620 = 	{filename = "LOK_D1_sheet",		double = true, doublesided = false, size = {3888, 7712}, sizeSh = {4096, 8192}, shift = {0.42,-1.125}},
		...
		yir_kr_green = 			{filename = "se_krgreen_sheet",	double = true, doublesided = false, size = {3760, 7392}, sizeSh = {4096, 7968}, shift = {0.42,-1.125}},
		yir_mre044 = 			{filename = "sel_dkred",		double = true, doublesided = false, size = {4096, 6688}, sizeSh = {4096, 7296}, shift = {0.42,-1.125}},
		yir_loco_steam_wt580of ={filename = "se_wt580of_sheet",	double = true, doublesided = false, size = {3904, 8128}, sizeSh = {4096, 8192}, shift = {0.42,-1.125}},
	},
	["cargo-wagon"] = {
		yir_us_cargo = 				{filename = "usw_sheet", 			double = false, doublesided = true,	size = {1904, 2016}, sizeSh = {2752, 2016}, shift = {0.42,-1.125}},
		...
		z_yira_4a_cw_energy = 		{filename = "4aw_cw_energy1_sheet", double = false, doublesided = true,	size = {3680, 4096}, sizeSh = {4096, 4096}, shift = {0.42,-1.125}},
		z_yira_4a_cw_eb1 = 			{filename = "4aw_cw_eb1_sheet", 	double = false, doublesided = true,	size = {3664, 4096}, sizeSh = {4096, 4096}, shift = {0.42,-1.125}},
		z_yira_4a_cw_gears = 		{filename = "4aw_cw_gears1_sheet", 	double = false, doublesided = true,	size = {3872, 4096}, sizeSh = {4096, 4096}, shift = {0.42,-1.125}},
		z_yira_4a_cw_kiste1 = 		{filename = "4aw_cw_kiste1_sheet", 	double = false, doublesided = true,	size = {3904, 4096}, sizeSh = {4096, 4096}, shift = {0.42,-1.125}},
		z_yira_4a_cw_ziegelgrau = 	{filename = "4aw_cw_ziegel_grau_sheet", double = false, doublesided = true,	size = {3872, 4096}, sizeSh = {4096, 4096}, shift = {0.42,-1.125}},
		z_yira_4a_cw_ziegelrot = 	{filename = "4aw_cw_ziegel_rot_sheet", 	double = false, doublesided = true,	size = {3872, 4096}, sizeSh = {4096, 4096}, shift = {0.42,-1.125}},
		...
		z_yira_4a_cw_yigreen = 		{filename = "4aw_cargo_green_sheet", 	double = false, doublesided = true,	size = {3520, 3856}, sizeSh = {4096, 3856}, shift = {0.42,-1.125}},
